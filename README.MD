...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/@MAFIyUA1/File-To-Link)
...
`OWNER_ID` : Your Telegram User ID MAFIyUA1
